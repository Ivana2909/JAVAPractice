...
public class Motor extends MotornoVozilo{
    ...
    public Motor(int trajanjeGume, boolean ostecenje,
    ...
    public Motor(ArrayList<Tocak> brojTockova, double cena1, int godinaProizvodnje) {
